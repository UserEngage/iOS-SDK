...
/// returns:
/// SDK Instance
- (nonnull instancetype)initWithApplication:(UIApplication * _Nonnull)application apiKey:(NSString * _Nonnull)apiKey baseURL:(NSString * _Nonnull)baseURL shouldTrackActivities:(BOOL)shouldTrackActivities OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
